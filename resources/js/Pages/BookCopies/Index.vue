  ...
  <AuthenticatedLayout>
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <h1 class="text-xl font-bold">Borrowed copies</h1>
        <div class="bg-white">
          <ResponsiveTable :data="borrowed_copies.data" :headers="headers"></ResponsiveTable>
        </div>
      </div>
    </div>
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <h1 class="text-xl font-bold">Requested copies</h1>
        <div class="bg-white">
          <ResponsiveTable :data="requested_copies.data" :headers="headers"></ResponsiveTable>
        </div>
      </div>
      <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
...
export default {
  props: ['book_copies', "requested_copies", "borrowed_copies"],
  computed: {
    headers() {
      return {
        id: 'ID',
